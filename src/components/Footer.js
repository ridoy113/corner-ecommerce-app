            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6 ">
                  Hmo: Abidpur, Bourichong,
                  <br /> Comilla <br />
                  PinCode: 018749
                </address>
                <a
                  href="tel:+880 1874997427"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +880 1874997427
                </a>
                <a
                  href="mailto:almamounhridoy113@gmail.com"
                  className="mt-2 d-block mb-0 text-white"
                >
                  almamounhridoy113@gmail.com
                </a>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by Dev Ridoy
              </p>
            </div>
          </div>
        </div>
